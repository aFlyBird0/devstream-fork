setTimeout(function() {
    ...
    script.src = 'https://devstream.readthedocs.io/_/api/v2/footer_html/?'+
        'callback=' + callbackName + '&project=devstream&page=&theme=mkdocs.yaml&format=jsonp&docroot=docs&source_suffix=.md&version=' + (window['READTHEDOCS_DATA'] || { version: 'latest' }).version;
